                        ...
                        <div class="donation-details__left">
                            <div class="donation-details__top">
                                ...
                                <div class="donation-details__content">
                                    <h3 class="donation-details__title">Epidermolizis Bulloza(Kəpənək) xəstəliyi</h3>
                                    <p class="donation-details__text">Yaşama dəstək 2017-ci ildə xeyriyyəçi Abil Hüseynquliyev 
                                        və Elgül Hüseynquliyeva tərəfindən yaradılmışdır. Yaranma səbəbi Elgül xanımın üç çarəsiz,
                                         nadir xəstəlikdən əziyyət çəkən insanlarla qarşılaşması olub.  Bunlardan biri Epidermolizis
                                          Bulloza(Kəpənək) çox nadir vəacınacaqlı dəri xəstəliyidir. Qohum evliliyindən yaranan xəstəlikdir.
                                           Bu xəstəlikdən əziyyət çəkən insanlar yanaraq həyat yaşayır. Tam müalicəsi olmasa da rahat yaşamaları 
                                           üçün müalicələri var. Lakin bu müalicələr çox böyük vəsait tələb edir. Xəstəlik çox böyük fəsadlar verir.
                                            Əllər bağlanır, boğazlarından yemək keçmir. Xüsusi plastrlar, kremlərlə rahat yaşaya bilirlər. Plastr və
                                             kremlər 
                                        byük vəsait tələb etdiyi üçün ailələr həmin müalicəni övladlarına edə bilmirlər. </p>
                                </div>
                            </div>
                            <div class="donation-details__donate">
                                ...
                                <div class="donation-details__donate-btn">
                                    <a href="donate-now.php" class="thm-btn">Detek ol</a>
                                </div>
                            </div>
