<?php include 'includes/header.php'; ?>
                        ...
                        <div class="about-one__right">
                            ...
                            <ul class="list-unstyled about-one__points">
                                <li>
                                    ...
                                    <div class="text">
                                        <h5><a href="become-volunteer.html">Ən son tədbir və görüşlərimiz</a></h5>
        ...
        <section class="causes-one">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">Xəbərlər və bloqlar paneli</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="events-one__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Ən son görüşlərimiz</h2>
                            </div>
                            ...
                            <div class="feature-one__top">
                                <div class="feature-one__top-inner">
                                    ...
                                    <div class="feature-one__top-title-box">
                                        <h3 class="feature-one__top-title"><a href="become-volunteer.html">Bizə qoşul</h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="feature-one__single feature-one__single--two">
                            ...
                            <div class="feature-one__top">
                                <div class="feature-one__top-inner">
                                    ...
                                    <div class="feature-one__top-title-box">
                                        <h3 class="feature-one__top-title"><a href="about.html">İanə et</a></h3>
                                    </div>
                                </div>
                            </div>
                            <p class="feature-one__text">Mauris feugiat at orci ac congue. mauris ut <br> lacus quis
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="testimonial-one__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">İctimai nüfuzlu şəxslərin fikirləri </h2>
                            </div>
        ...
        <section class="gallery-one">
            <div class="gallery-one__top">
                <h3 class="gallery-one__top-title">Uşaqlar</h3>
            </div>
        ...
        <section class="news-one">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="section-title__title">Gələcək tədbirlər planı</h2>
                </div>
                <div class="row">
